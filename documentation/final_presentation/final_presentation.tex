...
\end{equation*}
\centering
	\includegraphics[width=8cm, height=5.5cm ]{system_model/mixture_model}
...
\centering
		\includegraphics[width=8cm, height=5.5cm ]{system_model/channel_output}
...
\frametitle{Detection Performance: Quantizer}
	\includegraphics[width=\textwidth, height = 6cm]{system_model/quantizer_good}
