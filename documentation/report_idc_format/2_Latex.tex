...
\end{figure}
In this work, the upper and lower saturation levels are chosen based on the set of training data such that no received symbols are clipped to the saturation level.
...
\subsection{Simulation Details}\label{implementation_details}
...
\par
Last, we evaluate the LTI channels with quantization and the additional channel randomness described in equation \eqref{lti_quantized_channel}. (TODO Add figures)
