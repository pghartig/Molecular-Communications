...
Each state change is decided by the metric $ Pr(y_{\mathrm{i}}|\mathbf{x})$. In a linear channel with finite impulse response, this metric becomes 
...
\item Generate training data for molecular communications channel
\end{itemize}
\end{frame}

\begin{frame}
\frametitle{Supplement: Data Generation Details}
