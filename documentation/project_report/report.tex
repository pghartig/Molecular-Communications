...
%        \> 3.\ Update $\lambda := \beta \lambda$. \\*[\smallskipamount]
    ...
    \end{tabbing}}
    \noindent\rule[10pt]{\textwidth}{0.4pt}
As $p(y_{\mathrm{i}})$ is constant over all states in a given step of the Viterbi algorithm, this term in the Baye's decomposition may be interpreted as a weighting factor for the cost of one received symbol in the total path cost. (More detail on this or enough?)
...
TODO discuss case for reduced states as these may no longer be equiprobable.
